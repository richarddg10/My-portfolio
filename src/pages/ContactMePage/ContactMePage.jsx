            ...
            <section className="flex flex-col md:flex-row items-center justify-center pt-[29%] md:pt-[9.3%] pb-[25%] md:pb-[4.8%] gap-[13vw] md:gap-[8%]">
                <div className="relative flex justify-center items-center w-[70%] md:w-[34.5%]">
                    <div className="logos-container">
                        ...
                        <a href="https://drive.google.com/file/d/1IjwzEQxILOb0dIWs6a2GAGfp7pq1f4v4/view?usp=sharing" target="_blank" rel="noopener noreferrer">
                            <img src={spanishCvLogo} alt="spanish cv icon" />
                        </a>
                        <a href="https://drive.google.com/file/d/1GxFhRKs0nm6wbe8D6ezjYEk071WM2i8M/view?usp=sharing" target="_blank" rel="noopener noreferrer">
