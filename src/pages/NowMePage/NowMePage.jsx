...
import { LogosHeader, PopUp, SkillContainer, WaveFooter } from "../../components";
                ...
                <div className="flex flex-col justify-center items-center order-2 md:order-1">
                    <div className="flex flex-col items-start order-2 md:order-1">
                        ...
                        <div className="inline-flex flex-row gap-[25.2px] w-auto m-[14%_0_0_0] md:m-[14%_0_14%_0]">
                            ...
                            <div className="relative inline-flex flex-row justify-center" ref={dropDownRef}>
                                {isPopUpOpen && (
                                    <PopUp />
                                )}
                                <button 
                                    className="my-cv-btn relative z-2 px-[30.6px] md:px-[36.5px] py-[2.5%] bg-black text-[1.4rem] md:text-[1.5rem] text-primary-green border-[1.5px] border-primary-green rounded-[100px]"
