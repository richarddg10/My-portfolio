        ...
        <div className='contactContainer'>
          <div className='myRedContainer'>
            ...
            <div className='CVspanishDiv'>
              ...
              <a href='https://drive.google.com/file/d/1kFbUtlN4P9s-SQp-PrQqiyXWjADltA00/view?usp=share_link' target='_blank' rel='noreferrer'>See CV (in spanish)</a>
            </div>
            <div className='CVenglishDiv'>
              <img src={CVenglishIcon} />
              <a href='https://drive.google.com/file/d/1AfqsBbu729rEP0GFm4yNHnuMguete5bZ/view?usp=share_link' target='_blank' rel='noreferrer'>See CV (in english)</a>
            </div>
          </div>
