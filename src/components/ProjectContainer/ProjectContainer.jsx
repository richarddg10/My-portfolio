            ...
            <div className="project-content flex flex-col items-center cursor-pointer" onClick={handleProjectRedirect}>
                ...
                <div className="project-info absolute w-[93%] md:w-[95%] bottom-[5%] flex flex-row items-center justify-between">
                    <div className="text-white">
                        <h1 className="text-[0.9rem] md:text-[1.3rem] font-bold">
                            {projectName}
                            <span className="text-[0.6rem] md:text-[1rem] italic font-regular"> {extraInfo}</span>
                        </h1>
                        <h2 className="text-[0.6rem] md:text-[1rem] italic font-regular">{projectArea}</h2>
                    </div>
                    <img className="w-[1.7vw] md:w-[0.8vw]" src={whiteArrow} alt="Right arrow" />
                </div>
            </div>
        </div>
    )
