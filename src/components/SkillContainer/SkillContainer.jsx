    ...
    return (
        <div className="border-skill-container">
            <div className="skill-container flex flex-col items-center p-[11vw] sm:p-[3.2vw] gap-[5vw] md:gap-[1.5vw] bg-black text-white rounded-[10px]" ref={containerRef}>
                ...
                <div>
                    <p className="flex flex-row w-auto gap-[8px] text-[0.7em] sm:text-[1em]"><img className="w-[1vw] md:w-[0.4vw]" src="/green-arrow.svg" alt={skill1}/>{skill1}</p>
                    <p className="flex flex-row w-auto gap-[8px] text-[0.7em] sm:text-[1em]"><img className="w-[1vw] md:w-[0.4vw]" src="/green-arrow.svg" alt={skill2}/>{skill2}</p>
                    <p className="flex flex-row w-auto gap-[8px] text-[0.7em] sm:text-[1em]"><img className="w-[1vw] md:w-[0.4vw]" src="/green-arrow.svg" alt={skill3}/>{skill3}</p>
                </div>
